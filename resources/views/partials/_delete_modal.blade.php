<div x-show="deleteModalOpen" @keydown.escape.window="deleteModalOpen = false"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div x-show="deleteModalOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            class="fixed inset-0 bg-gray-500/70 bg-opacity-75 transition-opacity" @click="deleteModalOpen = false">
        </div>
        ...
        <div x-show="deleteModalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Anda yakin ingin menghapus data ini? Tindakan ini tidak dapat diurungkan.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                {{-- Form action-nya di-bind dengan Alpine --}}
